...
class ReturnTextFieldDelegate: NSObject, UITextFieldDelegate {
    ...
    fileprivate var onEndEditing: ((_ textField: UITextField) -> Void)?
     ...
     */
    func nextTo(textField: UITextField) -> ReturnTextFieldDelegate {
    ...
    /**
     下一个接收TextField
     */
    func next(textField: UITextField) -> ReturnTextFieldDelegate {
        self.nexts.append(textField)
        return self
    }
    ...
    /**
     下一个接收按钮
     */
    func next(button: UIButton) -> Self {
    ...
    /**
     下一个接收TextView
     */
    func next(textView: UITextField) -> Self {
    ...
    /**
     ...
     - returns:
     */
    func onReturn(_ action: @escaping (_ textField: UITextField) -> (Bool)) -> Self {
        self.onReturn = action
        return self
    }
    
    func onEndEditing(_ action: @escaping (_ textField: UITextField) -> Void) -> Self {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        //回调
        if let onReturn = self.onReturn, !onReturn(textField) {
            returnValue = false
        }
        return returnValue
    }
